...
def runPredict(idx):
    ...
    calculator = runnerCalculator(model_dir=MODEL_DIR,
    ...
    # first get fmax indices than get qm_fmax and runner fmax component
    ...
    #  print(runner_energy, qm_energy)
    runner_fmax_component = get_fmax_componentFrom_idx(runner_forces, qm_fmax_component_idx)

    return idx, len(atoms), qm_energy,  runner_energy, qm_fmax_component, runner_fmax_component
...
for result in tqdm.tqdm(pool.imap_unordered(func=runPredict, iterable=range(len_db)), total=len_db):
    ...
    idx, n_atoms, qm_energy,  runner_energy, qm_fmax_component, runner_fmax_component = result
    diffE = qm_energy - runner_energy
    diffEpa = diffE / n_atoms

    diffFamxComp = runner_fmax_component - qm_fmax_component
    print("Frame_{},{},{}".format(idx, qm_energy/n_atoms , runner_energy/n_atoms), file=fl_energy)
    print("Frame_{},{},{}".format(idx, qm_fmax_component, runner_fmax_component), file=fl_forces)
